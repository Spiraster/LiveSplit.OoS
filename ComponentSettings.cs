...
{
    public partial class OoSSettings : UserControl
    {
        ...
        public OoSSettings()
        {
            ...
            list.Add(new string[] { "D1", "fertile soil" });
            list.Add(new string[] { "D2", "gift of time" });
            list.Add(new string[] { "D3", "bright sun" });
            list.Add(new string[] { "D4", "soothing rain" });
            list.Add(new string[] { "D5", "nurturing warmth" });
            list.Add(new string[] { "D6", "blowing wind" });
            list.Add(new string[] { "D7", "seed of life" });
            list.Add(new string[] { "D8", "changing seasons" });
            list.Add(new string[] { "Onox", "defeat onox" });
            ...
            list.Add(new string[] { "ENP", "enter northern peak" });
